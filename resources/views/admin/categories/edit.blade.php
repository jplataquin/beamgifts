    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <h1 class="h3 fw-bold mb-0 text-primary">Edit Category: {{ $category->name }}</h1>
            </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                        ...
                        <div class="d-grid mt-5">
                            <button type="submit" class="btn btn-primary rounded-pill py-2 fw-bold">Update Category</button>
                        </div>
                    </form>
                </div>
            </div>
