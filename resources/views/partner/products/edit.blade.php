    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="d-flex align-items-center mb-4">
                ...
                <h1 class="h3 fw-bold mb-0 text-primary">Edit Product: {{ $product->name }}</h1>
            </div>

            <div class="card shadow-sm border-0 p-4">
                <div class="card-body">
                    <form id="productForm" action="{{ route('partner.products.update', $product) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="border rounded-4 p-4 text-center bg-light mb-3" id="dropZone" style="border-style: dashed !important; border-width: 2px !important;">
                                        ...
                                        <div class="py-2">
                                            <p class="mb-0 small text-muted">Add more images</p>
                                            <button type="button" class="btn btn-sm btn-link p-0 text-decoration-none fw-bold" onclick="document.getElementById('fileInput').click()">browse</button>
                                        </div>
                                    </div>
                        ...
                        <div class="d-grid mt-5">
                            <button type="submit" class="btn btn-primary rounded-pill py-3 fw-bold shadow-sm" id="submitBtn">Update Product</button>
                        </div>
                    </form>
                </div>
            </div>
