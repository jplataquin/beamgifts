    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <h1 class="h3 fw-bold mb-0 text-primary">Add Branch to {{ $store->name }}</h1>
            </div>

            <div class="card shadow-sm border-0 p-4">
                <div class="card-body">
                    <form action="{{ route('partner.branches.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $store->name . ' - ') }}" placeholder="e.g. Manila Central Branch" required>
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" class="form-control @error('map_url') is-invalid @enderror" id="map_url" name="map_url" value="{{ old('map_url') }}" placeholder="https://goo.gl/maps/...">
                        ...
                        <div class="d-grid mt-5">
                            <button type="submit" class="btn btn-primary rounded-pill py-2 fw-bold">Add Branch</button>
                        </div>
                    </form>
                </div>
            </div>
